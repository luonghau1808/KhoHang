namespace DuAn1_Nhom4
{
    partial class FormMain
    {
        ...
        private void InitializeComponent()
        {
            ...
            panelSidebar.Controls.Add(btnXuatHang);
            ...
            panelSidebar.Size = new Size(283, 954);
            ...
            btnDangXuat.Image = Properties.Resources.icons8_logout_30;
            btnDangXuat.ImageAlign = ContentAlignment.MiddleLeft;
            btnDangXuat.Location = new Point(0, 861);
            btnDangXuat.Name = "btnDangXuat";
            btnDangXuat.Size = new Size(283, 77);
            btnDangXuat.TabIndex = 23;
            ...
            btnLichSu.Location = new Point(0, 784);
            ...
            btnTaiKhoan.Location = new Point(0, 707);
            btnTaiKhoan.Name = "btnTaiKhoan";
            btnTaiKhoan.Size = new Size(283, 77);
            btnTaiKhoan.TabIndex = 21;
            ...
            // btnXuatHang
            // 
            btnXuatHang.Dock = DockStyle.Top;
            btnXuatHang.FlatAppearance.BorderSize = 0;
            btnXuatHang.FlatAppearance.MouseDownBackColor = Color.CornflowerBlue;
            btnXuatHang.FlatAppearance.MouseOverBackColor = Color.CornflowerBlue;
            btnXuatHang.FlatStyle = FlatStyle.Flat;
            btnXuatHang.Font = new Font("Segoe UI Semibold", 13F, FontStyle.Bold);
            btnXuatHang.ForeColor = SystemColors.ActiveCaptionText;
            btnXuatHang.Image = Properties.Resources.icons8_shopify_30;
            btnXuatHang.ImageAlign = ContentAlignment.MiddleLeft;
            btnXuatHang.Location = new Point(0, 630);
            btnXuatHang.Name = "btnXuatHang";
            btnXuatHang.Size = new Size(283, 77);
            btnXuatHang.TabIndex = 20;
            btnXuatHang.Text = "Xuất hàng";
            btnXuatHang.UseVisualStyleBackColor = true;
            btnXuatHang.Click += btnHoaDon_Click;
            // 
            // btnNhapHang
            // 
            btnNhapHang.Dock = DockStyle.Top;
            btnNhapHang.FlatAppearance.BorderSize = 0;
            btnNhapHang.FlatAppearance.MouseDownBackColor = Color.CornflowerBlue;
            btnNhapHang.FlatAppearance.MouseOverBackColor = Color.CornflowerBlue;
            btnNhapHang.FlatStyle = FlatStyle.Flat;
            btnNhapHang.Font = new Font("Segoe UI Semibold", 13F, FontStyle.Bold);
            btnNhapHang.ForeColor = SystemColors.ActiveCaptionText;
            btnNhapHang.Image = Properties.Resources.icons8_delivery_time_30;
            btnNhapHang.ImageAlign = ContentAlignment.MiddleLeft;
            btnNhapHang.Location = new Point(0, 553);
            btnNhapHang.Name = "btnNhapHang";
            btnNhapHang.Size = new Size(283, 77);
            btnNhapHang.TabIndex = 19;
            ...
            btnNCC.Image = Properties.Resources.icons8_mortgage_30;
            ...
            btnSanPham.FlatAppearance.MouseDownBackColor = Color.CornflowerBlue;
            btnSanPham.FlatAppearance.MouseOverBackColor = Color.CornflowerBlue;
            btnSanPham.FlatStyle = FlatStyle.Flat;
            btnSanPham.Font = new Font("Segoe UI Semibold", 13F, FontStyle.Bold);
            btnSanPham.ForeColor = SystemColors.ActiveCaptionText;
            btnSanPham.Image = Properties.Resources.icons8_product_30;
            btnSanPham.ImageAlign = ContentAlignment.MiddleLeft;
            btnSanPham.Location = new Point(0, 322);
            btnSanPham.Name = "btnSanPham";
            btnSanPham.Size = new Size(283, 77);
